...
export const en: Translations = {
  ...
  home: {
    ...
    heroSub:
      "We identify time-consuming, repetitive processes in your company and automate them end-to-end. We don't sell technology — we sell results.",
    ctaPrimary: 'Request Demo →',
    ctaSecondary: 'Explore Solutions',
    statsValue1: '8+',
    statsLabel1: 'Industries Served',
    statsValue2: '65%',

...
export const tr: Translations = {
  ...
  home: {
    ...
    heroSub:
      'Şirketinizdeki tekrarlayan, zaman çalan süreçleri tespit edip otomasyona geçiriyoruz. Teknoloji değil, sonuç satıyoruz.',
    ctaPrimary: 'Demo Talep Et →',
    ctaSecondary: 'Çözümleri İncele',
    statsValue1: '8+',
    statsLabel1: 'Sektörde Deneyim',
    statsValue2: '%65',
    statsLabel2: 'Ort. Manuel İş Azalması',
    statsValue3: '48s',
    statsLabel3: 'İlk Geri Dönüş',
    trustLabel: 'Güvendikleri',
